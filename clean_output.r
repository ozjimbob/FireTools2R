...
terra::writeRaster(temp_d,paste0(rast_temp,"/r_LastYearBurnt.tif"),overwrite=TRUE)
...
temp_d = temp_d * mask_tif_t
terra::writeRaster(temp_d,paste0(rast_temp,"/r_NumTimesBurnt.tif"),overwrite=TRUE)
...
temp_d = temp_d * mask_tif_t
terra::writeRaster(temp_d,paste0(rast_temp,"/r_TimeSinceLast.tif"),overwrite=TRUE)
