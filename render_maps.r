...
tm =  tm_shape(stex,is.master = TRUE) + tm_rgb() +tm_shape(v,name="Fire Management Blocks Threshold Status") +
  tm_fill(col="color",
          style="cat",
          alpha = 0.7,
...
tm = tm_shape(stex,is.master = TRUE) + tm_rgb() +tm_shape(v,name="SFAZ Treatment Status") +
  tm_fill(col="color",
          style="cat",
          alpha = 0.7,
...
tm = tm_shape(stex,is.master=TRUE) + tm_rgb() + tm_shape(v,name="Heritage Fire Blocks and SFAZ Status") +
  tm_fill(col="color",
          style="cat",
          alpha = 0.7,
...
tm =  tm_shape(stex,is.master=TRUE) + tm_rgb() + tm_shape(v,name="FMZ SFAZ Status") +
  tm_fill(col="color",
          style="cat",
          alpha = 0.7,
...
tm =tm_shape(stex,is.master=TRUE) + tm_rgb() + tm_shape(v,name="Time Since Last Fire") +
...
tm =tm_shape(stex,is.master=TRUE) + tm_rgb() +  tm_shape(v,name="Number of Times Burnt") +
